        ...
        <div className='fixed bottom-0 w-full h-48 p-4 flex items-start bg-slate-900 border-t border-gray-600 md:h-32 md:px-12'>
            ...
            <div className="relative grow">
                <InputWithLabel
                    ...
                    placeholder='Say hi!'
                />
                <div className='absolute text-slate-500 bottom-2 right-2'>
                    <p>{value.length}/{max}</p>
                </div>
            </div>
            <Button
                className='mt-[22px] ml-4 transition-[width] active:scale-95'
                onClick={handleMessage}
            >{isSending ?
                <div className='flex items-center gap-2'>
                    <svg aria-hidden="true" className="w-6 h-6 text-cyan-500 animate-spin fill-gray-200" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
